    ...
    if (sbPrintPretty_) {
      rasCAT(
        rasPASTE0(
          ...
          rasPASTE0(
            rcsAnsiBOLD_, csColorMainText_, "F-START { <F-SID: '", rcsAnsiRESET_
          ),
          rasPASTE0(
            rcsAnsiBOLD_, csColorCallerID_, ssFuncSelfID_, rcsAnsiRESET_
          ),
          rasPASTE0(
            rcsAnsiBOLD_, csColorMainText_, "'  F-Type: '", rcsAnsiRESET_
          ), 
          ssFuncType_,
          rasPASTE0(
            rcsAnsiBOLD_, csColorMainText_, "'>  F-Caller: '", rcsAnsiRESET_
          ), 
          ssFuncCallerID_,
          rasPASTE0(
            rcsAnsiBOLD_, csColorMainText_, "'  <Time: ", rcsAnsiRESET_
          ), 
          csTimeStamp_,
          rasPASTE0(
            rcsAnsiBOLD_, csColorMainText_, ">  }\n", rcsAnsiRESET_
          )
        )
      );
    } else {
     ...
     if (sbPrintPretty_) {
       rasCAT(
        rasPASTE0(
          csIconCarat_, ssProjID_, csIconSplit_,
          rasPASTE0(
            rcsAnsiBOLD_, csColorMainText_, "F-STOP { <F-SID: '", rcsAnsiRESET_
          ),
          rasPASTE0(
            rcsAnsiBOLD_, csColorCallerID_, ssFuncSelfID_, rcsAnsiRESET_
          ),
          ...
          csTimeStamp_,
          rasPASTE0(
            rcsAnsiBOLD_, csColorMainText_, " ( F-RunTime: ", rcsAnsiRESET_
          ),
          rasPASTE0(
